...
Aprés avoir utilisé beautifulSoup pour scraper les données de Avito sur les voitures
J'ai fait le preprocessing
commr estimateur il a été utilisé le gridsearch 
                                     lazypredict
